...
const createBusinessOfferingOptionSchema = baseBodySchema.superRefine(refineTranslations);
const updateBusinessOfferingOptionSchema = baseBodySchema.partial().superRefine((data, ctx) => {
...
const listBusinessOfferingOptionsSchema = z.object({
...
module.exports = { createBusinessOfferingOptionSchema, updateBusinessOfferingOptionSchema, listBusinessOfferingOptionsSchema, idParamSchema };
