...
const serviceTypeBodySchema = baseServiceTypeBodySchema.superRefine(refineTranslations);

const createServiceTypeSchema = serviceTypeBodySchema;
const updateServiceTypeSchema = baseServiceTypeBodySchema.partial().superRefine((data, ctx) => {
